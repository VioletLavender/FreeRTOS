...
int main(void)
{
    ...
    /* Config UART DMA */
    UARTx_DMA_Configure(DEBUG_UART);

    /* Config UART with parameter(115200, N, 8, 1) for printf */
    ...
    while(1)
    {
        ...
        /* Receive 10 Bytes Data By DMA */
        UARTx_DMA_RxData(DEBUG_UART, Buffer, 10);

        printf("\r\n\r\nThe Characters You Input : ");

        /* Transmit 10 Bytes Data By DMA */
        UARTx_DMA_TxData(DEBUG_UART, Buffer, 10);
    }
}

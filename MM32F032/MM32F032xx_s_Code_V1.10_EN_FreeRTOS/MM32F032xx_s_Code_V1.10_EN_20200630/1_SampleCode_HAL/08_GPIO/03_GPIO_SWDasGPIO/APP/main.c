...
int main(void)
{
    ...
    /* Delay 3 seconds for next programming avoid SWD bus conflicts */
    SysTick_DelayMs(3000);

    /* Config SWD(PA13 & PA14) as GPIO */
    GPIO_Configure();
    ...
    while(1)
    {
        /* connect PA13 to LED3 and PA14 to LED4 */

        /* Toggle LED1~LED4 status */
        BSP_LED1_TOGGLE();
        BSP_LED2_TOGGLE();
        PA13_TOGGLE();  //---BSP_LED3_TOGGLE();
        PA14_TOGGLE();  //---BSP_LED4_TOGGLE();

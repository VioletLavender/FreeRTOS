...
#define BSP_LED3_ON()       GPIO_WriteBit(LED3_GPIO, LED3_PIN, Bit_RESET)
#define BSP_LED4_ON()       GPIO_WriteBit(LED4_GPIO, LED4_PIN, Bit_RESET)

#define BSP_LED1_OFF()      GPIO_WriteBit(LED1_GPIO, LED1_PIN, Bit_SET)
#define BSP_LED2_OFF()      GPIO_WriteBit(LED2_GPIO, LED2_PIN, Bit_SET)
#define BSP_LED3_OFF()      GPIO_WriteBit(LED3_GPIO, LED3_PIN, Bit_SET)
#define BSP_LED4_OFF()      GPIO_WriteBit(LED4_GPIO, LED4_PIN, Bit_SET)
...
#define BSP_LED3_TOGGLE()   (GPIO_ReadOutputDataBit(LED3_GPIO, LED3_PIN) ? BSP_LED3_ON() : BSP_LED3_OFF())
#define BSP_LED4_TOGGLE()   (GPIO_ReadOutputDataBit(LED4_GPIO, LED4_PIN) ? BSP_LED4_ON() : BSP_LED4_OFF())

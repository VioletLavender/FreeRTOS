...
/* Private variables --------------------------------------------------------*/
volatile uint8_t I2C_DMA_RxFlag = 0;
...
void I2C_DMA_RxData(uint8_t *RxData, uint16_t RxSize)
{
    ...
    /* DMA1 Channel3 I2C_RC Interrupt Configuration */
...
{
    /* DMA1 Channel3 I2C_RC Transmit Completed Flag */
    if(DMA_GetITStatus(DMA1_IT_TC3))
    {
        I2C_DMA_RxFlag = 1;

        /* Clear DMA1 TC3 Interrupt Flag */
